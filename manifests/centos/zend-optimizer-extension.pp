class php::centos::zend-optimizer-extension
{
    ...
    file{
        'install-php-zend-optimizer.sh':
            ...
            content => template('php/centos/install-php-zend-optimizer.erb'),
            require => [
        ...
        'zend-optimizer-extension-ini':
            ...
            content => template('php/centos/zend-optimizer-extension-ini.erb'),
