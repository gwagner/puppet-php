class php::mongo-1_2-extension
{
    include php::config

    $installingMongoDriverVersion = $php::config::mongo_1_2_version
    ...
    file{
        ...
        'mongo-package':
            ...
            owner => "root",
            group => "root",
            path => "/tmp/mongo-php-driver-${php::config::mongo_1_2_version}.tar.gz",
            source => "puppet:///modules/php/mongo-php-driver-${php::config::mongo_1_2_version}.tar.gz";
        'mongo-extension-ini':
            mode => 644,
            owner => "root",
            group => "root",
            path => "/etc/php.d/mongo.ini",
            content => template('php/mongo-1_2-extension-ini.erb');
    }
